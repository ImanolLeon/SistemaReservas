...
public interface ReservaRepository extends JpaRepository<Reserva, Long> {
    ...
    Long contarCrucesReservaBalon(@Param("idBalon") Long idBalon , @Param("horaFinal")  LocalTime horaFinal ,
                                  @Param("horaInicio") LocalTime horaInicio, @Param("dia") String dia);
